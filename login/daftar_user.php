...
<body>
            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        ...
                        <form method="POST" class="register-form" id="register-form">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="name" placeholder="Your Complate Name" required/>
                            </div>
							 <div class="form-group">
                                <label for="name"><i class="zmdi zmdi-account material-icons-name"></i></label>
                    ...
                    <div class="signup-image">
                        ...
                        <a href="login_user.php" class="signup-image-link">I am already registered</a>
                    </div>
                </div>
            </div>
        </section>
	...
	{
	$sql = 'insert into daftar_user values("","'.$name.'","'.$username.'","'.$email.'","'.$password.'","'.date('Y-m-d').'")';
