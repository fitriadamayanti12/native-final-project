...
<body>
                ...
                <div class="signin-content">
                    <div class="signin-image">
                        <figure><img src="images/signup-image.jpg" alt="sing up image"></figure>
						  <a href="daftar_admin.php" class="signup-image-link">Create an account</a>
                    </div>
	...
	$query          = mysqli_query ($connect, "SELECT*FROM daftar_admin WHERE username='$username' AND password='$password'");
	...
	else
	{
	 $_SESSION['username'] = $hasil['username'];
		...
		document.location='../submenu/admin.php'
		</script>";
	}
	}
	}
