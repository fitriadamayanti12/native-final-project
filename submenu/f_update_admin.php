   ...
   <a align="center" style="text-decoration:none">
    <font face="Comic Sans MS" size="3" color="#F0FFF0"><div align="center">Input Data</div></font></a>
      ...
      <td rowspan="19" valign="top">
	  	 ...
	  	 <!-- Tabel -->
	  <form id="form1" name="form1" method="POST" action="update_admin.php">
	  <table width="500" border="1" style="border: 5px double #4169E1;" align="center" cellspacing="0" bgcolor="" >
	  <br>
      <tr height="45">
        <td colspan="3" bgcolor="">
		<font face="Comic Sans MS" size="4" color="#F0FFF0">
		<div align="center"><b>Edit Data Admin</b></div></font></a>
		</td>
      </tr>
	  <?php 
$connect = mysqli_connect('localhost','root','','db_sertifikasi');
$id_admin=$_GET['id'];
$query   = mysqli_query($connect,"select * from db_sertifikasi.admin where id_admin='$id_admin'");
while($row=mysqli_fetch_array($query))
	...
	?>
        ...
        <input type="hidden" name="id_admin"  id="id_admin" value="<?php echo $row[0]; ?>" />
...
<?php
	   ...
	   <tr height="30">
        ...
        <textarea type="text" name="alamat"><?php echo $row[10]; ?></textarea>
		</td>
      </tr>
      ...
      <tr height="30">
        ...
        <td width="200"><label for="textfield"></label>
        <input type="text" name="no_hp"  value="<?php echo $row[11]; ?>" /></td>
      </tr>
