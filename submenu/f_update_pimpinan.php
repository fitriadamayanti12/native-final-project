   ...
   <a align="center" style="text-decoration:none">
    <font face="Comic Sans MS" size="3" color="#F0FFF0"><div align="center">Input Data</div></font></a>
      ...
      <td rowspan="19" valign="top">
	   ...
	   <!-- Tabel -->
	    <form id="form1" name="form1" method="POST" action="update_pimpinan.php">
	  <table width="500" border="1" style="border: 5px double #4169E1;" align="center" cellspacing="0" bgcolor="" >
	  <br>
      <tr height="45">
        <td colspan="3" bgcolor="">
		<font face="Comic Sans MS" size="4" color="#F0FFF0">
		<div align="center"><b>Edit Data Pimpinan</b></div></font></a>
		</td>
      </tr>
...
$id_pimpinan=$_GET['id'];
$query   = mysqli_query($connect,"select * from db_sertifikasi.pimpinan where id_pimpinan='$id_pimpinan'");
while($row=mysqli_fetch_array($query))
	...
	?>
        <input type="hidden" name="id_pimpinan" id="id_pimpinan" value="<?php echo $row[0];?>" />
      ...
      <tr height="30">
        ...
        <input type="text" name="nip" id="nip" value="<?php echo $row[1];?>" />
		</td>
      </tr>
	  ...
	  <tr height="30">
        ...
        <td width="200"><label for="textfield"></label>
        <input type="text" name="nama" value="<?php echo $row[2];?>" />
		</td>
      </tr>
...
<?php
	   ...
	   <tr height="30">
        ...
        <textarea type="text" name="alamat" ><?php echo $row[8];?></textarea>
		</td>
      </tr>
      ...
      <tr height="30">
        ...
        <td width="200"><label for="textfield"></label>
        <input type="text" name="no_hp" value="<?php echo $row[9];?>" /></td>
      </tr>
