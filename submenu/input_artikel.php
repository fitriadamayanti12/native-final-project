...
$query   = mysqli_query($connect,'insert into db_sertifikasi.artikel values("","'.$judul.'","'.$isi.'","'.$penulis.'","'.$gambar.'","'.date('Y-m-d').'")');

if($query)
{
echo "<script>alert('Data Berhasil Disimpan')</script>";
echo "<meta http-equiv=refresh content=1;url=input_artikel.php>";
}
else
{
   ...
   <a align="center" style="text-decoration:none">
	...
	<form id="form1" name="form1" method="post" action="" enctype="multipart/form-data">
      ...
      <tr height="45">
		...
		<font face="Comic Sans MS" size="4" color="#F0FFF0">
		<div align="center"><b>Input Data Artikel</b></div></font></a>
		</td>
      </tr>
	  ...
	  <tr height="30">
        ...
        <input type="text" placeholder="wajib diisi" name="judul"/>
		</td>
      </tr>
	   ...
	   <tr height="100">
        ...
        <textarea style="width:300px; height:100px" name="isi" ></textarea>
		</td>
      </tr>
	   ...
	   <tr height="30">
        ...
        <td width="200"><label for="textfield"></label>
        <input type="text" placeholder="wajib diisi" name="penulis"/>
		</td>
      </tr>
