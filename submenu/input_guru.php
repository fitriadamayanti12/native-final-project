...
$query = mysqli_query($connect,"insert into db_sertifikasi.guru_pai values('$','$nip','$nama','$tempat','$tahun-$bulan-$tanggal',
'$jenis_kelamin','$pendidikan_terakhir','$program_studi','$status_kepegawaian','$status_penugasan','$golongan','$alamat','$no_hp')");

if($query)
{
echo "<script>alert('Data Berhasil Disimpan')</script>";
echo "<meta http-equiv=refresh content=1;url=input_guru.php>";
}
else
{
    ...
    <font face="Comic Sans MS" size="3" color="#F0FFF0"><div align="center">Input Data</div></font></a>
	 ...
	 <!-- Tabel -->
      ...
      <tr height="45">
		...
		<font face="Comic Sans MS" size="4" color="#F0FFF0">
		<div align="center"><b>Input Data Guru PAI</b></div></font></a>
		</td>
      </tr>
	  ...
	  <tr height="30">
        ...
        <td width="200"><label for="textfield"></label>
        <input type="text" placeholder="Wajib diisi" name="tempat" /></td>
      </tr>
...
<?php
	   ...
	   <tr height="30">
        ...
        <textarea type="text" placeholder="Wajib diisi" name="alamat"></textarea>
		</td>
      </tr>
