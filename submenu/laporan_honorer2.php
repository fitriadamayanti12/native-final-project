   ...
   <a align="center" style="text-decoration:none">
    <font face="Comic Sans MS" size="3" color="#F0FFF0"><div align="center">Input Data</div></font></a>
      ...
      <tr height="45">
		...
		<font face="Comic Sans MS" size="4" color="#F0FFF0">
		<a href="print_lap_honorer.php"><img width="30" align="left" src="../img/cetak.png"></a>
		<div align="center"><b>Laporan Data Guru PAI Honorer Bersertifikasi</b></div></font></a>
		</td>
      </tr>
      <tr>
	  <td bgcolor="#6495ED">
...
$query   = mysqli_query($connect,"SELECT * from db_sertifikasi.laporan_honorer");
