...
$query   = mysqli_query($connect,'insert into db_sertifikasi.pemberitahuan values("","'.$subjek.'","'.$isi.'","'.$gambar.'","'.date('Y-m-d').'")');

if($query)
{
echo "<script>alert('Pemberitahuan Berhasil Dikirim')</script>";
echo "<meta http-equiv=refresh content=1;url=pemberitahuan.php>";
}
else
{
echo "<script>alert('Pemberitahuan Gagal Dikirim')</script>";
echo "<meta http-equiv=refresh content=1;url=pemberitahuan.php>";
}
}
?>
   ...
   <a align="center" style="text-decoration:none">
	...
	<form id="form1" name="form1" method="post" action="" enctype="multipart/form-data">
      ...
      <tr height="45">
		...
		<font face="Comic Sans MS" size="4" color="#F0FFF0">
		<div align="center"><b>Input Pemberitahuan</b></div></font></a>
		</td>
      </tr>
	  ...
	  <tr height="30">
        ...
        <input type="text" placeholder="wajib diisi" name="subjek"/>
		</td>
      </tr>
	   ...
	   <tr height="100">
        ...
        <textarea style="width:300px; height:100px" type="text" name="isi" ></textarea>
		</td>
      </tr>
