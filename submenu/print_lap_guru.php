...
$pdf->Cell(400,13,'Laporan Data Guru PAI',0,1,'C');
...
$pdf->Cell(25,13,'Program Studi',1,0);
...
$pdf->Cell(27,13,'Siswa yang Diajar',1,1);
...
while ($row = mysqli_fetch_array($query)){
	...
	$pdf->Cell(25,13,$row['program_studi'],1,0);
	...
	$pdf->Cell(27,13,$row['jumlah_siswa_diajar'],1,1);
