   ...
   <a align="center" style="text-decoration:none">
	...
	<form id="form1" name="form1" method="post" action="">
      ...
      <tr height="45">
		...
		<font face="Comic Sans MS" size="4" color="#F0FFF0">
		<div align="center"><b>Data Artikel</b></div></font></a>
		</td>
      </tr>
      <tr>
	  <td bgcolor="#6495ED">
	  ...
	  <td bgcolor="#6495ED">
	  <font face="Comic Sans MS" size="2" color="#F0FFF0">
	  <div align="center"><b>Judul</b></div></font></a>
	  </td>
	  <td bgcolor="#6495ED">
	  <font face="Comic Sans MS" size="2" color="#F0FFF0">
	  ...
	  <td bgcolor="#6495ED">
	  <font face="Comic Sans MS" size="2" color="#F0FFF0">
	  <div align="center"><b>Penulis</b></div></font></a>
	  </td>
	  <td bgcolor="#6495ED">
	  <font face="Comic Sans MS" size="2" color="#F0FFF0">
	  <div align="center"><b>Gambar</b></div></font></a>
	  </td>
	  <td bgcolor="#6495ED">
	  <font face="Comic Sans MS" size="2" color="#F0FFF0">
	  <div align="center"><b>Tanggal Publikasi</b></div></font></a>
	  </td>
	  <td bgcolor="#6495ED">
	  <font face="Comic Sans MS" size="2" color="#F0FFF0">
...
$query   = mysqli_query($connect,"SELECT * from db_sertifikasi.artikel");
...
<!-- End Proses -->
	  ...
	  <td bgcolor="#6495ED">
	  <font face="Comic Sans MS" size="2" color="#F0FFF0">
	  <div align="center"><b><?php echo $row['isi']; ?></b></div></font></a>
	  </td>
	  <td bgcolor="#6495ED">
	  <font face="Comic Sans MS" size="2" color="#F0FFF0">
	  <div align="center"><b><?php echo $row['penulis']; ?></b></div></font></a>
	  </td>
	  <td bgcolor="#6495ED">
	  <font face="Comic Sans MS" size="2" color="#F0FFF0">
	  <div align="center"><b><?php echo '<img height="95" width="130" src="photo-artikel/'.$row['photo'].'">' ; ?></b></div></font></a>
	  </td>
	  <td bgcolor="#6495ED">
	  <font face="Comic Sans MS" size="2" color="#F0FFF0">
	  ...
	  <td bgcolor="#6495ED">
	  <a href="delete_artikel.php?id=<?php 
	  echo "$id_artikel";?>"><meta name="viewport" ><img width="25" src="../img/hapus.png"></a> 
	  <a href="f_update_artikel.php?id=<?php 
		echo "$id_artikel";?>"><img width="25" src="../img/edit.png"></a>
	  </td>
	  </tr>
	  <?php $no=$no+1;} ?>
    </table>
