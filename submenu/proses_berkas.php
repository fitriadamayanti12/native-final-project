...
<tr height="45">
   ...
   <a align="center" style="text-decoration:none">
    <font face="Comic Sans MS" size="3" color="#F0FFF0"><div align="center">Input Data</div></font></a>
	  ...
	  <table width="950" border="1" style="border: 5px double #4169E1;" align="center" cellspacing="0" bgcolor="" >
	  <br>
      <tr height="45">
        <td colspan="18" bgcolor="#6495ED">
		<font face="Comic Sans MS" size="4" color="#F0FFF0">
		<div align="center"><b>Data Berkas Sertifikasi Guru PAI</b></div></font></a>
		</td>
      </tr>
      <tr>
	  <td bgcolor="#6495ED">
	  ...
	  <td bgcolor="#6495ED">
	  <font face="Comic Sans MS" size="2" color="#F0FFF0">
	  <div align="center"><b>File NUPTK</b></div></font></a>
	  </td>
	  <td bgcolor="#6495ED">
	  <font face="Comic Sans MS" size="2" color="#F0FFF0">
	  <div align="center"><b>File SK</b></div></font></a>
	  </td>
	  <td bgcolor="#6495ED">
	  <font face="Comic Sans MS" size="2" color="#F0FFF0">
	  <div align="center"><b>File Ijazah</b></div></font></a>
	  </td>
	  <td bgcolor="#6495ED">
	  <font face="Comic Sans MS" size="2" color="#F0FFF0">
	  <div align="center"><b>File Transkrip Nilai</b></div></font></a>
	  </td>
	  <td bgcolor="#6495ED">
	  <font face="Comic Sans MS" size="2" color="#F0FFF0">
	  <div align="center"><b>File Surat Mengajar</b></div></font></a>
	  </td>
	  <td bgcolor="#6495ED">
	  <font face="Comic Sans MS" size="2" color="#F0FFF0">
	  <div align="center"><b>Tanggal Upload Berkas</b></div></font></a>
	  </td>
	  <td bgcolor="#6495ED">
	  <font face="Comic Sans MS" size="2" color="#F0FFF0">
...
$query   = mysqli_query($connect,"SELECT * from db_sertifikasi.berkas");
...
$id_berkas=$row['id_berkas'];
	?>
	  ...
	  <td bgcolor="#6495ED">
	  <font face="Comic Sans MS" size="2" color="#F0FFF0">
	  <div align="center"><b><?php echo $row['nuptk']; ?></b></div></font></a>
	  </td>
	  <td bgcolor="#6495ED">
	  <font face="Comic Sans MS" size="2" color="#F0FFF0">
	  <div align="center"><b><?php echo '<img height="40" width="40" src="berkas-sertifikasi/'.$row['nuptk_file'].'">'; ?></b></div></font></a>
	  </td>
	  <td bgcolor="#6495ED">
	  <font face="Comic Sans MS" size="2" color="#F0FFF0">
	  <div align="center"><b><?php echo '<img height="40" width="40" src="berkas-sertifikasi/'.$row['sk'].'">'; ?></b></div></font></a>
	  </td>
	  <td bgcolor="#6495ED">
	  <font face="Comic Sans MS" size="2" color="#F0FFF0">
	  <div align="center"><b><?php echo '<img height="40" width="40" src="berkas-sertifikasi/'.$row['ijazah'].'">'; ?></b></div></font></a>
	  </td>
	  <td bgcolor="#6495ED">
	  <font face="Comic Sans MS" size="2" color="#F0FFF0">
	  <div align="center"><b><?php echo '<img height="40" width="40" src="berkas-sertifikasi/'.$row['transkrip_nilai'].'">'; ?></b></div></font></a>
	  </td>
	  <td bgcolor="#6495ED">
	  <font face="Comic Sans MS" size="2" color="#F0FFF0">
	  <div align="center"><b><?php echo '<img height="40" width="40" src="berkas-sertifikasi/'.$row['surat_mengajar'].'">'; ?></b></div></font></a>
	  </td>
	  <td bgcolor="#6495ED">
	  <font face="Comic Sans MS" size="2" color="#F0FFF0">
	  <div align="center"><b><?php echo $row['tanggal_upload']; ?></b></div></font></a>
	  </td>
	  <td bgcolor="#6495ED">
	  <font face="Comic Sans MS" size="2" color="#F0FFF0">
	  <div align="center"><b><?php echo $row['status_berkas']; ?></b></div></font></a>
	  </td>
	  <td bgcolor="#6495ED">
	  <a href="delete_berkas.php?id=<?php 
	  echo "$id_berkas";?>"><meta name="viewport" ><img width="25" src="../img/hapus.png"></a> 
	  <a href="f_update_berkas.php?id=<?php 
		echo "$id_berkas";?>"><img width="25" src="../img/edit.png"></a>
	  </td>
	  </tr>
     <?php $no=$no+1;} ?>
    </table>
