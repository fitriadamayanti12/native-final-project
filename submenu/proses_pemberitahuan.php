   ...
   <a align="center" style="text-decoration:none">
	...
	<form id="form1" name="form1" method="post" action="">
      ...
      <tr height="45">
		...
		<font face="Comic Sans MS" size="4" color="#F0FFF0">
		<div align="center"><b>Data Pemberitahuan</b></div></font></a>
		</td>
      </tr>
      <tr>
	  <td bgcolor="#6495ED">
	  ...
	  <td bgcolor="#6495ED">
	  <font face="Comic Sans MS" size="2" color="#F0FFF0">
	  <div align="center"><b>Isi Pemberitahuan</b></div></font></a>
	  </td>
	  <td bgcolor="#6495ED">
	  <font face="Comic Sans MS" size="2" color="#F0FFF0">
...
$query   = mysqli_query($connect,"SELECT * from db_sertifikasi.pemberitahuan");
...
<!-- End Proses -->
	  ...
	  <td bgcolor="#6495ED">
	  <font face="Comic Sans MS" size="2" color="#F0FFF0">
	  <div align="center"><b><?php echo $row['isi_pemberitahuan']; ?></b></div></font></a>
	  </td>
	  <td bgcolor="#6495ED">
	  <font face="Comic Sans MS" size="2" color="#F0FFF0">
	  ...
	  <td bgcolor="#6495ED">
	  <a href="delete_pemberitahuan.php?id=<?php 
	  echo "$id_pemberitahuan";?>"><meta name="viewport" ><img width="25" src="../img/hapus.png"></a> 
	  <a href="f_update_pemberitahuan.php?id=<?php 
		echo "$id_pemberitahuan";?>"><img width="25" src="../img/edit.png"></a>
	  </td>
	  </tr>
	  <?php $no=$no+1;} ?>
    </table>
