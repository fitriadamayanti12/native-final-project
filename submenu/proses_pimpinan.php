...
<tr height="45">
   ...
   <a align="center" style="text-decoration:none">
    <font face="Comic Sans MS" size="3" color="#F0FFF0"><div align="center">Input Data</div></font></a>
	  ...
	  <table width="1000" border="1" style="border: 5px double #4169E1;" align="center" cellspacing="0" bgcolor="" >
	  <br>
      <tr height="45">
        <td colspan="18" bgcolor="#6495ED">
		<font face="Comic Sans MS" size="4" color="#F0FFF0">
		<div align="center"><b>Data Pimpinan</b></div></font></a>
		</td>
      </tr>
      <tr>
	  <td bgcolor="#6495ED">
...
$query   = mysqli_query($connect,"SELECT * from db_sertifikasi.pimpinan");
...
$id_pimpinan=$row[0];
	?>
	  ...
	  <td bgcolor="#6495ED">
	  <a href="delete_pimpinan.php?id=<?php 
	  echo "$id_pimpinan";?>"><meta name="viewport" ><img width="25" src="../img/hapus.png"></a> 
	  <a href="f_update_pimpinan.php?id=<?php 
		echo "$id_pimpinan";?>"><img width="25" src="../img/edit.png"></a>
	  </td>
	  </tr>
     <?php $no=$no+1;} ?>
    </table>
