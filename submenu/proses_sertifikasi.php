   ...
   <a align="center" style="text-decoration:none">
    <font face="Comic Sans MS" size="3" color="#F0FFF0"><div align="center">Input Data</div></font></a>
      ...
      <tr height="45">
		...
		<font face="Comic Sans MS" size="4" color="#F0FFF0">
		<div align="center"><b>Data Sertifikasi Guru PAI</b></div></font></a>
		</td>
      </tr>
      <tr>
	  <td bgcolor="#6495ED">
	  ...
	  <td bgcolor="#6495ED">
	  <font face="Comic Sans MS" size="2" color="#F0FFF0">
	  <div align="center"><b>Jumlah Siswa yang Diajar</b></div></font></a>
	  </td>
	  <td bgcolor="#6495ED">
	  <font face="Comic Sans MS" size="2" color="#F0FFF0">
	  <div align="center"><b>Jam Mengajar</b></div></font></a>
	  </td>
	  <td bgcolor="#6495ED">
	  <font face="Comic Sans MS" size="2" color="#F0FFF0">
	  <div align="center"><b>Tugas Tambahan</b></div></font></a>
	  </td>
	  <td bgcolor="#6495ED">
	  <font face="Comic Sans MS" size="2" color="#F0FFF0">
	  <div align="center"><b>Jam Tugas Tambahan</b></div></font></a>
	  </td>
	  <td bgcolor="#6495ED">
	  <font face="Comic Sans MS" size="2" color="#F0FFF0">
	  <div align="center"><b>Mengajar Sekolah Lain</b></div></font></a>
	  </td>
	  <td bgcolor="#6495ED">
	  <font face="Comic Sans MS" size="2" color="#F0FFF0">
	  <div align="center"><b>Jam Mengajar Sekolah Lain</b></div></font></a>
	  </td>
	   <td bgcolor="#6495ED">
	  <font face="Comic Sans MS" size="2" color="#F0FFF0">
...
$query   = mysqli_query($connect,"SELECT * from db_sertifikasi.sertifikasi");
...
$id_sertifikasi=$row[0];
	?>
	  ...
	  <td bgcolor="#6495ED">
	  <a href="delete_sertifikasi.php?id=<?php 
	  echo "$id_sertifikasi";?>"><meta name="viewport" ><img width="25" src="../img/hapus.png"></a> 
	  <a href="f_update_sertifikasi.php?id=<?php 
		echo "$id_sertifikasi";?>"><img width="25" src="../img/edit.png"></a>
	  </td>
	  </tr>
     <?php $no=$no+1;} ?>
    </table>
